...
*/
    ...
    private double givenResistance; 
    private double givenVoltage; 
    
public Resistor(double resistance) {

    givenResistance = resistance; 
}
...
return givenVoltage / givenResistance;
}
/**
...
public void setCurrent(double current) {
    ...
    givenVoltage = current * givenResistance; 
}
/**
* R
eturns the power (in Watts) dissipated by the Resistor.
*
* @return the power
*/
public double getPower() {

return (givenVoltage * givenVoltage) / givenResistance;
}
/**
